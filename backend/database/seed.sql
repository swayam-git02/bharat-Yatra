-- BHARAT YATRA DATABASE SEED DATA
USE `bharat_yatra`;
...
-- 3. SEED CORE DESTINATIONS (Representative 30+ detailed destinations covering major states & UTs)
...
-- 4. SEED TRANSPORT OPTIONS (India-Specific Recommendations)
...
(1, 'Scooty Rental', 'Rishikesh Scooty', '₹400 - ₹600 / day', 'Flexible', 'Best mode for navigating narrow suspension bridges & Tapovan cafes.', TRUE),
(2, 'Scooter / Thar', 'Goa Bike & Self-Drive Thar', '₹400 - ₹2500 / day', 'Flexible', 'Cruising coastal roads between North & South Goa beaches.', TRUE),
(3, 'E-Auto & Cab', 'Jaipur Pink City E-Auto', '₹300 - ₹800 / day', 'Flexible', 'Navigating old city bazaars and hilltop Amer fort.', TRUE),
(4, 'Rowboat & Walking', 'Varanasi Ghat Rowboats', '₹200 - ₹500 / ride', '1 Hour', 'Exploring ancient heritage galis and Ganges ghats.', TRUE),
(5, 'Houseboat', 'Alleppey Kettuvallam Houseboat', '₹6000 - ₹14000 / night', 'Full Day', 'Cruising palm-fringed backwaters of Vembanad lake.', TRUE),
(6, 'Royal Enfield 4x4', 'Ladakh Himalayan Bike', '₹1800 - ₹3500 / day', 'Full Day', 'High-altitude mountain road trip across Khardung La.', TRUE),
(12, 'Toy Train', 'Darjeeling Steam Toy Train', '₹300 - ₹800 / trip', '2 Hours', 'UNESCO heritage narrow gauge Joyride across Batasia Loop.', TRUE),
(16, 'AC Local Train', 'Mumbai Local & Kaali Peeli', '₹15 - ₹100 / trip', '30 Mins', 'Fast AC commuter train and iconic meter taxis.', TRUE),
(32, 'Delhi Metro', 'Delhi Metro System', '₹20 - ₹60 / trip', '30 Mins', 'Clean AC subway connecting heritage monuments & airport express.', TRUE)
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`);
